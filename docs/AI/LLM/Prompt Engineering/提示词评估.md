...
[+规模]: 这里的规模指需要评估的组合量：提示词数量 × 输入样本数量 × 模型数量

提示词评估要解决的是：**如何量化、可重复地衡量一条提示词的质量**。规模[+规模]小的时候凭感觉改提示词、肉眼盯着几条输出判断好坏还勉强够用，但规模一上来这种方式就彻底失灵了
...
[Promptfoo](https://www.promptfoo.dev/) 是专为提示词工程设计的开源测试 & 评估框架
